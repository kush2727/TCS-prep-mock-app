// ====================================================
// MISSION TCS DAILY MOCK — DAY 8  |  app.js
...
const STORAGE_KEY = 'tcs_mock_day8';      // score records (all students)
...
function applyStudentNameUI() {
    ...
    document.getElementById('topbarStudentName').textContent = `${studentName} — DAY 8`;
...
function exportCSV() {
    ...
    a.href = url; a.download = 'TCS_Mock_Day8_Scores.csv'; a.click();
